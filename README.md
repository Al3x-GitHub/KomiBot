...
<p align="center">
    ...
    <a href="https://t.me/NezukoDemonBot"> KomiBot </a>
</p>
...
```console
sudo docker build . -t Komi
sudo docker run Komi
```
...
from Komi import app # This is bot's client
...
# Many useful functions are in, Komi/utils/, Komi, and Komi/core/
```

<h3 align="center">
   And put that file in Komi/modules/, restart and test your bot.
</h3>
